...
/// Centralized color palette for the Martigo design system.
///
/// All other files (theme, widgets, screens) should reference these
/// constants instead of hard-coding color values.
class AppColors {
  AppColors._();
